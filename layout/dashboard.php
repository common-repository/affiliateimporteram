<?php
/**
 * @var $dashboard AIDN_DashboardPage
 */
use Dnolbon\Aidn\Tables\BlacklistTable;

$dashboard->prepare_items();

$errors = array_merge(get_settings_errors('aidn_dashboard_error'), get_settings_errors('aidn_goods_list'));

settings_errors('aidn_dashboard_error');

settings_errors('aidn_goods_list');
...
>
        ...
        <form id="aidn-search-form" method="GET">
            ...
            if ($dashboard->show_dashboard) {
                ...
                <div class="text_content btn_container">
                    <input type="button" id="aidn-do-filter" class="button button-primary" value="Search"/>
                </div>
                <?php
            }
            ?>
    ...
    <div class="tab_content" rel="results">
        <?php if ($dashboard->loader->hasAccount()) : ?>
            ...
            <div class="before_list">
                <?php do_action('aidn_before_product_list', $dashboard); ?>
            </div>
            <div id="aidn-goods-table" class="aidn-goods-table">
    ...
    <div class="tab_content" rel="blacklist">
        ...
        <div class="aidn-goods-table" id="aidn-goods-table-blacklist">
            <div class='import_process_loader'></div>
            <?php
    ...
    <div id="upload_image_dlg" style="display: none">
        <div>
            <form id="image_upload_form" method="post" action="#" enctype="multipart/form-data">
                ...
                <input type="hidden" name="action" id="action" value="aidn_upload_image"/>
