...
class WordpressMenu
{
    ...
    /**
     * @var WordpressMenu[] $childs
     */
    private $childs = [];
    /**
     * @var WordpressMenu $parent
     */
    private $parent;
    ...
    public function __construct($pageTitle, $capability, $menuSlug, $params = [])
    {
        ...
        if (array_key_exists('icon', $params)) {
            $this->icon = plugins_url('assets/img/' . $params['icon'], AIDN_FILE_FULLNAME);
        }
