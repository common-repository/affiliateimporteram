 ...
 *
 */
if (!class_exists('AIDN_AbstractAccount')) {

    /**
     * Class AIDN_AbstractAccount
     */
    abstract class AIDN_AbstractAccount
    {
        ...
        /**
         * AIDN_AbstractAccount constructor.
         * @param $api
         */
        ...
        public function load()
        {
            ...
            if ($this->default) {
                ...
                $results = $wpdb->get_results('SELECT * FROM ' . $wpdb->prefix . AIDN_TABLE_ACCOUNT . " WHERE name='" . get_class($this) . "'");
                if ($results) {
        ...
        public function save($data = array())
        {
            if ($data && isset($data['account_type']) && $data['account_type']) {
                 ...
                 */
                global $wpdb;
                $wpdb->replace($wpdb->prefix . AIDN_TABLE_ACCOUNT, array('id' => $this->id, 'name' => $this->name, 'data' => $serializedData));
